        ...
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600">Administra los usuarios del sistema y sus roles</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900">{{ $users->where('is_active', true)->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <div class="text-sm font-medium text-gray-500">Usuarios Inactivos</div>
                        <div class="text-2xl font-bold text-gray-900">{{ $users->where('is_active', false)->count() }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-900">{{ $users->filter(function($user) { return $user->hasRole('Administrador'); })->count() }}</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @if($user->roles->isNotEmpty())
                                    @foreach($user->roles as $role)
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                            ...
                                            @elseif($role->name === 'Secretario') bg-blue-100 text-blue-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('users.toggle-status', $user) }}" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="text-yellow-600 hover:text-yellow-900" onclick="return confirm('¿Estás seguro de que deseas cambiar el estado de este usuario?')">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
